...
const OurCourses = () => {
  ...
  return (
    <div className="bg-gray-100 p-8 space-y-4">
      ...
      <Link
        className="bg-orange-400 py-2 px-4 rounded-lg text-white hover:bg-red-600 hover:scale-105 transform duration-300 mb-6 inline-block"
        to={"/admin/dashboard"}
      >
        Go to dashboard
      </Link>
        ...
        {courses.map((course) => (
          <div key={course._id} className="bg-white shadow-md rounded-lg p-4">
            ...
            <div className="flex justify-between mt-4 text-gray-800 font-bold">
              ...
              <div className="text-green-600 text-sm mt-2">11 % off</div>
            </div>
            ...
            <div className="flex justify-between">
              ...
              <button
                onClick={() => handleDeleteCourses(course._id)}
